...
local solzdark = lush(function()
	return {
		...
		-- FloatBorder               {}, -- Used for hovers
		 ...
		 DiagnosticVirtualTextInfo   { fg = blue }, -- Used for "Information" diagnostic virtual text
		 DiagnosticVirtualTextWarn   { fg = yellow }, -- Used for "Warning" diagnostic virtual text
