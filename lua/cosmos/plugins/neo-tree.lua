...
return lush(function()
	return {
		...
		NeoTreeGitAdded { fg = colors.parameter }, -- File name when the git status is added.
		...
		NeoTreeGitUntracked { fg = colors.parameter }, -- File name when the git status is untracked.
